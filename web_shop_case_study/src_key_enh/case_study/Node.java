...
public final class Node  {
    ...
    /*@ public normal_behavior
      ...
      @ ensures_free (true) && (this == null || this.tail == null || (this.tail != null &&this.tail.head.product.price >= this.head.product.price));
      @ ensures_free (true) && (tail == null || tail.tail == null || (tail.tail != null &&tail.tail.head.product.price >= tail.head.product.price));
      @ assignable \nothing;
      @ assignable \nothing;
      @*/
    ...
    /*@ public normal_behavior
      ...
      @ ensures_free (true) && (\result == null || \result.tail == null || (\result.tail != null &&\result.tail.head.product.price >= \result.head.product.price));
      @ ensures_free (true) && (\result == null || \result.tail == null || (\result.tail != null &&\result.tail.head.product.price >= \result.head.product.price));
      @ ensures_free (true) && (tail == null || tail.tail == null || (tail.tail != null &&tail.tail.head.product.price >= tail.head.product.price));
      @ assignable \nothing;
      @ assignable \nothing;
    ...
    public void insert(/*@nullable@*/ case_study.Order newHead) {
        ...
        ;
        ;
        if (newHead.__getPrice_trampoline(true) <= this.head.__getPrice_trampoline(true)) {
            ;
            ;
            this.__insertHead_trampoline(newHead, true, true, true);
        } else {
            ;
            ;
            this.__insertTail_trampoline(newHead, true, true, true);
        }
    }
    ...
    private void insertHead(/*@nullable@*/ case_study.Order newHead) {
        if (this.tail == null) {
            this.tail = Node.__INIT_trampoline(this.head, true);
        } else {
            this.tail = Node.__INIT_trampoline(this.head,this.tail, true, true, true);
        }
        this.head = newHead;
        ;
        ;
    ...
    private void insertTail(/*@nullable@*/ case_study.Order newHead) {
        if (tail == null) {
            this.tail = Node.__INIT_trampoline(newHead, true);
        } else {
            this.tail.__insert_trampoline(newHead, true, true, true);
        }
        ;
        ;
        //@ set footprint = \set_union(\singleton(this.head), \singleton(this.tail), \singleton(this.footprint), this.tail.footprint);
