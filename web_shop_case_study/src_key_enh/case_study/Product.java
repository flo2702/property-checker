...
public final class Product  {
    ...
    /*@ public normal_behavior
      ...
      @ ensures_free (ageRestriction >= 0) && (this != null && this.ageRestriction <= ageRestriction);
      @ ensures_free (0 >= 0 && 0 <= 2147483647) && (price >= 0 && price <= 2147483647);
      @ ensures_free (0 >= 0 && 0 <= 18) && (ageRestriction >= 0 && ageRestriction <= 18);
      @ assignable \nothing;
      @ assignable \nothing;
      @*/
    ...
    /*@ public normal_behavior
      ...
      @ ensures_free (ageRestriction >= 0) && (\result != null && \result.ageRestriction <= ageRestriction);
      @ ensures_free (ageRestriction >= 0) && (\result != null && \result.ageRestriction <= ageRestriction);
      @ ensures_free (0 >= 0 && 0 <= 2147483647) && (price >= 0 && price <= 2147483647);
      @ ensures_free (0 >= 0 && 0 <= 18) && (ageRestriction >= 0 && ageRestriction <= 18);
      @ assignable \nothing;
