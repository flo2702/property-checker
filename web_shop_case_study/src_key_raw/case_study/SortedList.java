...
public final class SortedList  {
    ...
    public void insert(/*@nullable@*/ case_study.Order newHead) {
        if (this.first == null) {
            this.first = Node.__INIT_trampoline(newHead, false);
        } else {
            this.first.__insert_trampoline(newHead, false, false, false);
        }
    ...
    public /*@nullable@*/ Order remove() {
        ...
        case_study.Order temp2 = this.first.__getHead_trampoline(false, false);
        result = temp2;
        this.first = this.first.__stealTail_trampoline(false, false);
        ;
    ...
    public /*@nullable@*/ Order removeIfPresent() {
        if (this.first != null) {
            return this.__remove_trampoline(false, false);
        } else {
            return null;
        }
    }
    ...
    public /*@nullable@*/ Order getHead() {
        return this.first.__getHead_trampoline(false, false);
    }
