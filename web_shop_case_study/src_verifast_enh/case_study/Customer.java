...
public final class Customer  {
    ...
    public Customer(String name, int age)
        ...
        //@ ensures [_]Customer_OwnFields(this, ?this_name_e, ?this_age_e) &*& [_]Customer_FieldTypes(this_name_e, this_age_e) &*& [_]AgedOver(this_age_e, age) &*& true &*& (name != null) &*& this_name_e == name &*& this_age_e == age;
    {
        super();
