...
public final class Product  {
    ...
    public Product(String title, int price, int ageRestriction)
        ...
        //@ ensures [_]Product_OwnFields(this, ?this_title_e, ?this_price_e, ?this_ageRestriction_e) &*& [_]Product_FieldTypes(this_title_e, this_price_e, this_ageRestriction_e) &*& [_]AllowedFor(this_ageRestriction_e, ageRestriction) &*& ([_](Interval(ageRestriction, 0, 18))) &*& ([_](Interval(price, 0, 2147483647))) &*& (title != null) &*& this_title_e == title &*& this_price_e == price &*& this_ageRestriction_e == ageRestriction;
    {
        super();
        ...
        //@ open Interval(price, 0, 2147483647);
        //@ close Interval(price, 0, 2147483647);
        //@ open Interval(ageRestriction, 0, 18);
        //@ close Interval(ageRestriction, 0, 18);
    }
